<?php
$ablakcim = array(
    'cim' => 'MATEGYE Alapítvány',
);

$fejlec = array(
	'cim' => 'Matematikában Tehetséges Gyermekekért Alapítvány',
	'motto' => '"A matematika, ha helyesen tekintjük, nemcsak igaz, hanem fölöttébb szép is; hidegen és egyszerűen szép, mint egy szobor."
(Bertrand Russell)'
);

$lablec = array(
    'ceg' => 'MATEGYE Alapítvány'
);
